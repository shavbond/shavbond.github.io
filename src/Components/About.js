               ...
               <div className="columns download">
                  <p>
                     <a href={resumeDownload} className="button">
                        ...
                        <a href="https://github.com/shavbond" className="button">
                        <i className="fa fa-github"></i>Github/Projects</a>
                        <a href="https://www.linkedin.com/in/shavar-anson-941ab279/" className="button">
